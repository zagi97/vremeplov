                    ...
                    <>
                      ...
                      <div className="mb-4 flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:items-center bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-300 hidden sm:inline">{t('profile.filterByYear')}:</span>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 sm:ml-auto">
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-300 hidden sm:inline">{t('profile.sortBy')}:</span>
