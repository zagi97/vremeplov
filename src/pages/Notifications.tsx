              ...
              <TabsContent value={activeFilter} className="mt-0">
                {loading ? (
                  <div className="p-12 text-center">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">{t('notifications.loadNotifications')}</p>
                  </div>
                        ...
                        const NotificationContent = (
                          <div
                            className={`p-4 sm:p-6 transition-colors ${
                              isClickable ? 'hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer' : 'cursor-default opacity-70'
                          ...
                          >
                            <div className="flex gap-3 sm:gap-4">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className={`text-sm sm:text-base ${!notification.read ? 'font-semibold' : 'font-medium'} text-gray-900 dark:text-gray-100 break-words`}>
                                  {message}
                                </p>
                                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1.5">{timeAgo}</p>
                              </div>
                  ...
                  <div className="p-12 sm:p-16 text-center">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Bell className="h-8 w-8 sm:h-10 sm:w-10 text-gray-400 dark:text-gray-500" />
                    </div>
