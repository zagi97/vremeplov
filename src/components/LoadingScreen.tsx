...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({
  ...
  const content = (
    <div className="flex flex-col items-center justify-center gap-6">
      ...
      <div className="flex flex-col items-center gap-1">
        <h2 className="text-xl font-bold text-gray-700 dark:text-gray-200 tracking-tight">
          VREMEPLOV
        </h2>
  ...
  return (
    <div className="flex min-h-[400px] w-full items-center justify-center bg-gray-50 dark:bg-gray-900">
      {content}
    </div>
  );
};
